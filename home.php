  ...
  <div class="content-box addons">
    <div class="container">
      ...
      <div class="addons-list columns cards">
        ...
        <a class="column card is-6 addon coldbox-addons" href="<?php _e( 'https://wordpress.org/plugins/coldbox-addon/', 'official' ); ?>">
          <div class="addon-image">
            <img src="<?php echo esc_url( get_theme_file_uri( 'img/icon-256x256.jpg' ) ); ?>" alt="coldbox-addons">
        ...
        <a class="column card is-6 addon ads" href="<?php _e( 'https://coldbox.miruc.co/addons/google-adsense-extension/', 'official' ); ?>">
          <div class="addon-image">
            <div class="addon-image">
              <img src="<?php echo esc_url( get_theme_file_uri( 'img/ads-extension.jpg' ) ); ?>" alt="coldbox-ads-extension">
              <span class="price-bar">
                <?php esc_html_e( '$20~', 'official' ); ?>
            </span>
            </div>
          </div>
          <div class="addon-content">
